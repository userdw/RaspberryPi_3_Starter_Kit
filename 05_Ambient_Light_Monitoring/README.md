...
4. Run the [Ambient_Light_Monitoring](/05_Ambient_Light_Monitoring) code into Raspberry Pi 3 using python.

Once you turn on the Raspberry Pi 3, it will enter calibration mode for about 3 seconds. Cover the LDR Sensor with your finger to determine the lowest brightness, and uncover the LDR Sensor to determine the highest brightness. Be careful of shadows.
...
4. Jalankan kode program [Ambient_Light_Monitoring](/05_Ambient_Light_Monitoring) pada Raspberry Pi 3 menggunakan python.
