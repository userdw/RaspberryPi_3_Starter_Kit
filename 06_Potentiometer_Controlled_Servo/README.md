...
5. Run the [Potentiometer_Controlled_Servo](/05_Potentiometer_Controlled_Servo) code in Raspberry Pi 3 using python.
...
5. Jalankan kode program [Potentiometer_Controlled_Servo](/05_Potentiometer_Controlled_Servo) pada Raspberry Pi 3 menggunakan python.
