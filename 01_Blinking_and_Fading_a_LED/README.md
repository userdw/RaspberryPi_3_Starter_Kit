...
4. To run the sample code, open a terminal and type the command :
```
python LED_Blinking.py
```
...
4. Untuk menjalankan sample code buka terminal lalu ketikkan perintah :
```
python LED_Blinking.py
```
